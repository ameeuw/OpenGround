...
// Status registers
    CC2500_30_PARTNUM          = 0x30 | CC2500_WRITE_BURST,        // Part number
    CC2500_31_VERSION          = 0x31 | CC2500_WRITE_BURST,        // Current version number
    CC2500_32_FREQEST          = 0x32 | CC2500_WRITE_BURST,        // Frequency offset estimate
    CC2500_33_LQI              = 0x33 | CC2500_WRITE_BURST,        // Demodulator estimate for link quality
    CC2500_34_RSSI             = 0x34 | CC2500_WRITE_BURST,        // Received signal strength indication
    CC2500_35_MARCSTATE        = 0x35 | CC2500_WRITE_BURST,        // Control state machine state
    CC2500_36_WORTIME1         = 0x36 | CC2500_WRITE_BURST,        // High byte of WOR timer
    CC2500_37_WORTIME0         = 0x37 | CC2500_WRITE_BURST,        // Low byte of WOR timer
    CC2500_38_PKTSTATUS        = 0x38 | CC2500_WRITE_BURST,        // Current GDOx status and packet status
    CC2500_39_VCO_VC_DAC       = 0x39 | CC2500_WRITE_BURST,        // Current setting from PLL cal module
    CC2500_3A_TXBYTES          = 0x3A | CC2500_WRITE_BURST,        // Underflow and # of bytes in TXFIFO
    CC2500_3B_RXBYTES          = 0x3B | CC2500_WRITE_BURST,        // Overflow and # of bytes in RXFIFO
